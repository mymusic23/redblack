...
// use redgold_schema::structs::{AddressDescriptor, PartyId, PublicKey};
...
// #[derive(Clone)]
// pub struct ActiveMultisigCreation {
//     pub last_peer_vecs: Vec<String>
// }

// #[derive(Clone)]
// pub struct MoneroWalletSyncWriter<B: PeerBroadcast + 'static> {
//     pub active_wallets: Vec<MoneroWalletCli>,
//     pub peer_broadcast: B,
//     pub active_creations: HashMap<AddressDescriptor, ActiveMultisigCreation>
// }
